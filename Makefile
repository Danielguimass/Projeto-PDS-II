...
${BUILD}/${TARGET}: ${BUILD}/bin/usuario.o ${BUILD}/bin/tabela.o ${BUILD}/bin/sudoku.o ${BUILD}/bin/cronometro.o ${BUILD}/bin/jogar.o ${BUILD}/bin/gerador.o ${BUILD}/bin/exceptions.o ${BUILD}/bin/main.o
	${CC} ${CFLAGS} ${BUILD}/bin/usuario.o ${BUILD}/bin/tabela.o ${BUILD}/bin/sudoku.o ${BUILD}/bin/cronometro.o ${BUILD}/bin/jogar.o ${BUILD}/bin/gerador.o ${BUILD}/bin/exceptions.o ${BUILD}/bin/main.o -o ${BUILD}/${TARGET}
...
${BUILD}/bin/exceptions.o: ${INCLUDE}/game/exceptions.hpp ${SRC}/game/exceptions.cpp
	${CC} ${CFLAGS} -I ${INCLUDE}/ -c ${SRC}/game/exceptions.cpp -o ${BUILD}/bin/exceptions.o

${BUILD}/bin/main.o: ${INCLUDE}/users/usuario.hpp ${INCLUDE}/users/tabela.hpp ${INCLUDE}/game/sudoku.hpp ${INCLUDE}/game/cronometro.hpp ${INCLUDE}/game/jogar.hpp ${INCLUDE}/game/gerador.hpp ${INCLUDE}/game/exceptions.hpp  ${SRC}/main.cpp
