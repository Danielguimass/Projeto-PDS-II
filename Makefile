...
${TARGET}: ${BUILD}/historias.o ${BUILD}/sudoku.o ${BUILD}/cronometro.o ${BUILD}/main.o
	${CC} ${CFLAGS} ${BUILD}/historias.o ${BUILD}/sudoku.o ${BUILD}/cronometro.o ${BUILD}/main.o -o ${TARGET}
...
${BUILD}/main.o: ${INCLUDE}/historias.hpp ${INCLUDE}/sudoku.hpp ${INCLUDE}/cronometro.hpp  main.cpp
