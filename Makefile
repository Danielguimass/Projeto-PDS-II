...
${BUILD}/${TARGET}: ${BUILD}/bin/usuario.o ${BUILD}/bin/tabela.o ${BUILD}/bin/estatisticas.o ${BUILD}/bin/sudoku.o ${BUILD}/bin/cronometro.o ${BUILD}/bin/jogar.o ${BUILD}/bin/gerador.o ${BUILD}/bin/main.o
	${CC} ${CFLAGS} ${BUILD}/bin/usuario.o ${BUILD}/bin/tabela.o ${BUILD}/bin/estatisticas.o ${BUILD}/bin/sudoku.o ${BUILD}/bin/cronometro.o ${BUILD}/bin/jogar.o ${BUILD}/bin/gerador.o ${BUILD}/bin/main.o -o ${BUILD}/${TARGET}
...
${BUILD}/bin/estatisticas.o: ${INCLUDE}/users/estatisticas.hpp ${SRC}/users/estatisticas.cpp
	${CC} ${CFLAGS} -I ${INCLUDE}/ -c ${SRC}/users/estatisticas.cpp -o ${BUILD}/bin/estatisticas.o
...
${BUILD}/bin/main.o: ${INCLUDE}/users/usuario.hpp ${INCLUDE}/users/tabela.hpp ${INCLUDE}/users/estatisticas.hpp ${INCLUDE}/game/sudoku.hpp ${INCLUDE}/game/cronometro.hpp ${INCLUDE}/game/jogar.hpp ${INCLUDE}/game/gerador.hpp  ${SRC}/main.cpp
